...
**Resumo executivo** — 15 verificações, 12 falhas, 3 warnings.
...
- **[ALTO] Turma criada não apareceu na lista**
  - Rota: `/turmas`
  - Evidência: ![Turma criada não apareceu na lista](qa-screenshots/falha-04-turma-criada-nao-apareceu-na-lista.png)
...
- **[ALTO] Pagamento financeiro sem confirmação de sucesso**
  - Rota: `/financeiro`
  - Evidência: ![Pagamento financeiro sem confirmação de sucesso](qa-screenshots/falha-07-pagamento-financeiro-sem-confirmacao-de-sucesso.png)
  - Descrição: Não apareceu toast de sucesso após confirmar pagamento.
  - Passos para reproduzir:
  - Abrir cobrança
  - Registrar pagamento
- **[ALTO] Produto cadastrado não apareceu no catálogo**
  - Rota: `/produtos`
  - Evidência: ![Produto cadastrado não apareceu no catálogo](qa-screenshots/falha-08-produto-cadastrado-nao-apareceu-no-catalogo.png)
  - Descrição: Card do produto recém-cadastrado não ficou visível.
  - Passos para reproduzir:
...
Call log:
[2m  - waiting for getByRole('dialog').first().getByLabel(/Nome do comprador/i) to be visible[22m
...
[2m  - waiting for getByRole('dialog').first().getByLabel(/Nome do comprador/i) to be visible[22m
    ...
    at D:\MATEUS\Documentos\GitHub\gestaoacademia\scripts\qa-mobile-runner.mjs:1010:11
    at stateAction (D:\MATEUS\Documentos\GitHub\gestaoacademia\scripts\qa-mobile-runner.mjs:159:9)
    at async produtosScenario (D:\MATEUS\Documentos\GitHub\gestaoacademia\scripts\qa-mobile-runner.mjs:1009:3)
    at async runScenario (D:\MATEUS\Documentos\GitHub\gestaoacademia\scripts\qa-mobile-runner.mjs:166:5)
    at async main (D:\MATEUS\Documentos\GitHub\gestaoacademia\scripts\qa-mobile-runner.mjs:1706:5)
    at async file:///D:/MATEUS/Documentos/GitHub/gestaoacademia/scripts/qa-mobile-runner.mjs:1746:1
  - Passos para reproduzir:
  - Executar cenário: Produtos e vendas
- **[ALTO] Reserva de aluguel não apareceu após confirmar**
  - Rota: `/aluguel`
  - Evidência: ![Reserva de aluguel não apareceu após confirmar](qa-screenshots/falha-10-reserva-de-aluguel-nao-apareceu-apos-confirmar.png)
  - Descrição: Não foi possível localizar reserva recém-criada na lista.
  - Passos para reproduzir:
  - Abrir Nova Reserva
...
- **[MEDIO] Regra de graduação não apareceu após criação**
  - Rota: `/graduacao`
  - Evidência: ![Regra de graduação não apareceu após criação](qa-screenshots/falha-05-regra-de-graduacao-nao-apareceu-apos-criacao.png)
  - Descrição: A nova faixa destino não foi encontrada na listagem de regras.
  - Passos para reproduzir:
  - Abrir Nova Regra
  - Preencher e criar
  - Verificar listagem
- **[MEDIO] Campeonato não apareceu após criação**
  - Rota: `/campeonatos`
  - Evidência: ![Campeonato não apareceu após criação](qa-screenshots/falha-06-campeonato-nao-apareceu-apos-criacao.png)
  - Descrição: Novo campeonato não ficou visível na listagem.
  - Passos para reproduzir:
  - Abrir Novo Campeonato
  - Salvar
  - Verificar listagem
- **[MEDIO] Warnings React/validateDOMNesting no console**
  - Rota: `/global`
  - Evidência: ![Warnings React/validateDOMNesting no console](qa-screenshots/falha-11-warnings-react-validatedomnesting-no-console.png)
  - Descrição: ⚠️ React Router Future Flag Warning: React Router will begin wrapping state updates in `React.startTransition` in v7. You can use the `v7_startTransition` future flag to opt-in early. For more information, see https://reactrouter.com/v6/upgrading/future#v7_starttransition. | ⚠️ React Router Future Flag Warning: Relative route resolution within Splat routes is changing in v7. You can use the `v7_relativeSplatPath` future flag to opt-in early. For more information, see https://reactrouter.com/v6/upgrading/future#v7_relativesplatpath. | ⚠️ React Router Future Flag Warning: React Router will begin wrapping state updates in `React.startTransition` in v7. You can use the `v7_startTransition` future flag to opt-in early. For more information, see https://reactrouter.com/v6/upgrading/future#v7_starttransition. | ⚠️ React Router Future Flag Warning: Relative route resolution within Splat routes is changing in v7. You can use the `v7_relativeSplatPath` future flag to opt-in early. For more information, see https://reactrouter.com/v6/upgrading/future#v7_relativesplatpath. | Warning: Missing `Description` or `aria-describedby={undefined}` for {DialogContent}. | Warning: Missing `Description` or `aria-describedby={undefined}` for {DialogContent}. | Warning: Missing `Description` or `aria-describedby={undefined}` for {DialogContent}. | Warning: Missing `Description` or `aria-describedby={undefined}` for {DialogContent}. | Warning: Missing `Description` or `aria-describedby={undefined}` for {DialogContent}. | Warning: Missing `Description` or `aria-describedby={undefined}` for {DialogContent}. | Warning: Missing `Description` or `aria-describedby={undefined}` for {DialogContent}. | Warning: Missing `Description` or `aria-describedby={undefined}` for {DialogContent}. | Warning: Missing `Description` or `aria-describedby={undefined}` for {DialogContent}.
  - Passos para reproduzir:
  - Executar fluxo completo
  - Inspecionar console warnings
- **[MEDIO] Alvos de toque abaixo de 44x44**
  - Rota: `/global`
  - Evidência: ![Alvos de toque abaixo de 44x44](qa-screenshots/falha-12-alvos-de-toque-abaixo-de-44x44.png)
...
- [✗ falhou] Campeonatos → Novo Campeonato: Falha ao criar campeonato.
- [✗ falhou] Financeiro → Registrar Pagamento: Falha ao registrar pagamento.
- [✗ falhou] Aluguel → Nova Reserva: Falha ao criar reserva.
...
- Entradas rastreadas de erro/pageerror (ignorando ruído /rows /status): 0
