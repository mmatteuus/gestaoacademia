...
app.listen(port, () => {
  ...
  console.log(`   GET  /rows?type=Turmas       - Listar turmas`);
  console.log(`   GET  /rows?type=Graduacao   - Listar graduações`);
  console.log(`   GET  /rows?type=Campeonatos - Listar desafios`);
  console.log(`   GET  /rows?type=Medalhas     - Listar medalhas`);
  console.log(`   GET  /rows?type=Produtos     - Listar produtos`);
  console.log(`   GET  /rows?type=Vendas       - Listar vendas`);
  console.log(`   GET  /rows?type=Aluguel      - Listar alugueis`);
  console.log(`   GET  /rows?type=Professores  - Listar professores`);
