...
import { alunos, cobrancas, alertas, atividadesRecentes, graduacoesAlunos, frequenciaMensal, receitaDespesaMensal, receitas, despesas, vendas, produtos } from '@/mocks/data';
import { Users, AlertTriangle, Award, DollarSign, TrendingDown, Package, Building2, CalendarCheck } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const ocupacao = Math.round((alunos.filter(a => a.status === 'ativo').length / 60) * 100);
