        ...
        {filtered.map((r, i) => {
          ...
          return (
            <div
              key={r.alunoId}
              className={cn(
                "bg-card border border-border rounded-lg p-4 flex items-center gap-4 hover:bg-accent/30 transition-colors",
                isTop3 && r.posicao === 1 && "border-primary/30 glow-primary-sm"
              )}
            >
              <div className={cn(
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] text-muted-foreground bg-muted px-1.5 py-0.5 rounded">{r.categoria}</span>
                </div>
                <div className="flex items-center gap-3 mt-1 text-xs text-muted-foreground">
                  <span>{r.vitorias} vitórias</span>
                  <span>{r.medalhas} medalhas</span>
                </div>
              </div>
              <div className="text-right shrink-0">
                <div className="text-lg font-bold text-foreground">{r.pontuacao}</div>
                <div className={cn(
