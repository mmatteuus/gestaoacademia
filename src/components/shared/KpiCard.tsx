...
export function KpiCard({ label, valor, variacao, icon, className }: KpiCardProps) {
  return (
    <div className={cn(
      "bg-card border border-border rounded-lg p-4 md:p-5 transition-colors hover:bg-accent/30 group",
      className
    )}>
      ...
      <div className="text-2xl md:text-3xl font-bold text-foreground tracking-tight">{valor}</div>
      {variacao !== undefined && (
        <div className={cn(
