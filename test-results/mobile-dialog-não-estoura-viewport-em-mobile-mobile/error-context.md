...
- Name: mobile.spec.ts >> dialog não estoura viewport em mobile
- Location: e2e\mobile.spec.ts:45:1
      ...
      - generic [ref=e19]:
        - generic [ref=e20]:
          - generic [ref=e21]:
            ...
            - paragraph [ref=e23]: 680 alunos cadastrados
          - generic [ref=e25]:
...
```ts
  ...
  16 |   await expect(page.getByRole('heading', { name: 'Dashboard' }).first()).toBeVisible({ timeout: 15000 });
  17 | 
  ...
  34 |   await expect(page.getByRole('heading', { name: 'Dashboard' }).first()).toBeVisible({ timeout: 15000 });
  35 | 
  ...
  49 |   await expect(page.getByRole('heading', { name: 'Dashboard' }).first()).toBeVisible({ timeout: 15000 });
  50 | 
